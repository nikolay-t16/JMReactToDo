	...
	public render() {
		...
		return (
			<li className={this.className}>
				<div className="view">
					<input className="toggle" checked={task.isCompleted} onChange={this.onChangeCompleted.bind(this)} type="checkbox"/>
					<label>
						<span className="description">{task.text}</span>
						<span
							className="created"
						>
							created {formatDistanceToNow(task.date, {includeSeconds: true})} ago
						</span>
					</label>
